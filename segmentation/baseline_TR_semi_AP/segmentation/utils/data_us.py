...
class ImageToImage2D(Dataset):
    def __init__(self, dataset_path: str, split='train', style_tf=None, joint_transform: Callable = None, img_size=256, prompt = "click", class_id=1,
        ...
        self.class_dict_file = "/mnt/HDD1/tuong/TRUST/downstream/segmentation/SAMUS/dataset/US30K/MainPatient/class.json" # os.path.join(dataset_path, 'MainPatient/class.json')
    ...
    def __getitem__(self, i):
        ...
        ### Style Transfer ###
        image_style = Image.open(img_path).convert("RGB")
