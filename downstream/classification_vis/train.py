...
def main():
    ...
    # Data parameters
    parser.add_argument("--train_dir", type=str, default="../../dataset/Breast-UDIAT/train")
    parser.add_argument("--val_dir", type=str, default="../../dataset/Breast-UDIAT/valid")
    parser.add_argument("--test_dir", type=str, default="../../dataset/Breast-UCLM/valid")
    ...
    if args.model == 'resnet34':
        ...
        model = timm.create_model('timm/vit_base_patch16_224', pretrained=True, num_classes=num_classes)
    else:
