...
def main():
    ...
    parser.add_argument("--test_dir", default="/mnt/HDD1/tuong/TRUST/segmentation/baseline_TR_semi_AP/cp_UCLM2BUSI_TR_semi20_AP_1024/results/results_12.0k")
    parser.add_argument('--source_test_dir', default='/mnt/HDD1/tuong/TRUST/dataset/Breast-UCLM/valid.txt')
